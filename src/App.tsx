...
export default function Home() {
  ...
  const claimedSupply = useTokenSupply(contractQuery.contract);
  ...
  const priceToMint = useMemo(() => {
    ...
    return `${utils.formatUnits(
      bnPrice.mul(debouncedQuantity).toString(),
  ...
  const isLoading = useMemo(() => {
    return activeClaimCondition.isLoading || !contractQuery.contract;
  }, [activeClaimCondition.isLoading, contractQuery.contract]);
                ...
                <div className="flex w-full flex-col gap-4">
                  <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:gap-4 ">
                    ...
                    <Web3Button
                      ...
                      theme={theme}
                      action={(cntr) => cntr.erc20.claim(debouncedQuantity)}
